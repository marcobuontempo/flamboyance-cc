...
export default function Navbar({ }: Props) {
  return (
    <nav className='relative mx-auto flex sm:flex-row flex-col sm:h-16 h-26 items-center justify-between sm:px-5 px-2 border-black border-b-2 bg-cyan-300z font-LexendMega'>
