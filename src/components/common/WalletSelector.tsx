  ...
  return (
    <div className="flex flex-col gap-6 text-white/80">
        ...
        <>
          ...
          >
            ...
            <div className="relative">
              <ArrowIcon className="absolute right-0 top-0 bottom-0 m-auto mr-3 pointer-events-none" />
              <select
                className="h-14 bg-white/10 pl-5 pr-8 rounded-lg w-full border border-white font-medium text-xl cursor-pointer appearance-none"
            ...
            <Button
              className="w-full text-left flex justify-between items-center mt-4"
              variant="secondary"
            >
      ...
      >
        ...
        <input
          className="h-14 bg-white/10 px-5 rounded-lg w-full border border-white font-medium text-xl"
          type='text'
          placeholder="N..."
