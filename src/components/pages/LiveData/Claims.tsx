...
export default function Claims() {
  ...
  const columns: ColumnDef<TransformedLiveDataClaim>[] = [
    ...
    {
      header: `${preferredCurrency} Value`,
  ...
  const transformData = (entry: LiveDataClaim): TransformedLiveDataClaim => {
    ...
    return {
      ...
      amount_fiat: (entry.amount_usd * exchangeRate).toLocaleString('en-US', { style: 'currency', currency: preferredCurrency, minimumFractionDigits: 2, maximumFractionDigits: 2 }),
    }
  };
