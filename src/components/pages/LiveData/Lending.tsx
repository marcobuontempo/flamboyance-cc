...
export default function Lending() {
  ...
  const columns: ColumnDef<TransformedLiveDataLend>[] = [
    ...
    {
      header: `Collateral Price (${preferredCurrency})`,
    ...
    {
      header: `F Token Price (${preferredCurrency})`,
  ...
  const transformData = (entry: LiveDataLend): TransformedLiveDataLend => {
    ...
    return {
      ...
      collateral_fiat_price: (entry.collateral_usd_price * exchangeRate).toLocaleString('en-US', { style: 'currency', currency: preferredCurrency }),
      ...
      f_token_fiat_price: (entry.f_token_usd_price * exchangeRate).toLocaleString('en-US', { style: 'currency', currency: preferredCurrency }),
