    ...
    walletQuery.data && pricesQuery.data
      ? walletQuery.data.map(walletItem => {
        ...
        return {
          ...walletItem,
          ...priceData,
          fiat_amount: (parseFloat(walletItem.amount) * priceData.usd_price).toLocaleString('en-US', { style: 'currency', currency: 'USD', minimumFractionDigits: 2, maximumFractionDigits: 2 }),
        };
      })
